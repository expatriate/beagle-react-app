...
import {navigateToForget, navigateToSearch, addToCart, addToList} from '../../../actions';
...
class LandingPage extends Component {
  ...
  render() {
    ...
    let options, ratingStyles = ['#b4b4b4','#b4b4b4','#b4b4b4','#b4b4b4','#b4b4b4'];;
    ...
    if (inListFlag) {
      inList = <TouchableHighlight underlayColor="transparent" style={[styles.list_cart_wrapper, {marginRight: 10}]}>
                  <LinearGradient
      ...
      inList = <TouchableHighlight underlayColor="transparent" style={[styles.list_cart_wrapper, {marginRight: 10}]} onPress={this.addToListEvent}>
                  <LinearGradient
    ...
    if (inCartFlag) {
      inCart = <TouchableHighlight underlayColor="transparent" style={styles.list_cart_wrapper}>
                  <LinearGradient
                    colors={['#b4b4b4', '#b4b4b4']}
                    start={[0, 0]}
                    end={[1, 0]}
       ...
       inCart = <TouchableHighlight underlayColor="transparent" style={styles.list_cart_wrapper} onPress={this.addToCartEvent}>
                  <LinearGradient
                    colors={['#E30719', '#E30719']}
                    start={[0, 0]}
                    end={[1, 0]}
                    style={styles.tag_grad}>
                    <Text style={[styles.tag_text, {color: '#ffffff'}]}>Купить</Text>
                  </LinearGradient>
                </TouchableHighlight>
    }
    ...
    return (
      <View style={[styles.container, {backgroundColor: '#ffffff', flex: 1}]}>
        ...
        <ScrollView>
          ...
          <View style={[styles.row,{paddingTop: 20, marginTop: 20, paddingLeft: 24, paddingRight: 24}]}>
          ...
          <View style={[styles.content, styles.content_formated]}>
            <View style={[styles.col, {paddingLeft: 24, paddingRight: 24}]}>
              ...
              <View style={[styles.row, {alignItems: 'center', justifyContent: 'center', marginTop: 30}]}>
                <Text style={styles.subtitle_like}>
                  Нравится покупателям:
                </Text>
              </View>
              <View style={[styles.row, {alignItems: 'center', justifyContent: 'center', marginBottom: 30}]}>
                <Text style={[styles.list_head_s]}>
                  Дизайн, управление и&nbsp;картинка
                </Text>
              </View>
            </View>
            <View style={[styles.row, styles.buttons, {alignItems: 'center', justifyContent: 'center', marginTop: 10, marginBottom: 10}]}>
              { inList }
              { inCart }
            </View>
            <View style={styles.row}>
              <View style={[styles.col, {paddingLeft: 24, paddingRight: 24, marginBottom: 20}]}>
          ...
          <View style={{height: 40, flex: 1, backgroundColor: '#ffffff'}}>
          </View>
        </ScrollView>
      </View>);
  }
