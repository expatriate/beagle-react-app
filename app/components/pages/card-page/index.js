...
import {navigateToOnplace, navigateToSearch, successPay} from '../../../actions';
...
class CardPage extends Component {
  ...
  constructor(props) {
      ...
      this.successPayEvent = this.successPayEvent.bind(this);
    ...
    return (
      <View style={styles.container}>
        ...
        <Modal 
          ...
          <SuccessPayModal close={() => {
            this.refs.SUCCESSPAY.close();
            if (this.props.nav.routes.length > 4) {
              this.props.navigateToOnplace();
            } else {
              this.props.navigateToSearch();
        ...
        <ScrollView>
          ...
          <View style={styles.content}>
            <View>
              ...
              <Text style={styles.subtitle}>
                Товаров на сумму: {this.fullSum} Руб.
              </Text>
            </View>
            <View style={styles.card}>
              <LinearGradient
                colors={['#F92B44', '#E10C1C']}
                start={[0, 0]}
                end={[1, 0]}
                style={styles.card_grad}>
                <View>
                  <View style={styles.row}>
                    <View style={styles.card_number}>
                      <TextInput
                        style={styles.card_number_input}
                        placeholder="0000 0000 0000 0000"
                        value="8080 0000 0000 0001"
                        editable={false}
                      />
                    </View>
                  </View>
                  <View style={[styles.col, styles.card_date_title]}>
                    <View style={[styles.row]}>
                      <Text style={styles.card_date_title_text}>
                        MONTH/YEAR
                      </Text>
                    </View>
                    <View style={styles.row}>
                  ...
                  <View style={styles.row}>
                    <View style={styles.card_holder}>
                      <TextInput
                        style={styles.card_holder_input}
             ...
             <View style={[styles.backcard]}>
              <LinearGradient
                ...
                <View>
                  ...
                  <View style={[styles.col, styles.csv_date_title]}>
                    <View style={[styles.row]}>
                      <Text style={styles.card_date_title_text}>
                        CSV
                      </Text>
                    ...
                    <View style={styles.row}>
                      <View style={styles.card_csv}>
                        <TextInput
                          style={[styles.csv_input]}
                          placeholder="000"
                          editable={false}
                          value="123"
                        />
          ...
          <TouchableHighlight style={{width: '100%'}} underlayColor="transparent" onPress={() => {this.successPayEvent()}}>
            <View style={styles.pay_btn}>
              <Text style={styles.pay_btn_text}>Сделать заказ</Text>
            </View>
          </TouchableHighlight>
        </ScrollView>
      </View>);
  ...
  successPayEvent() {
    this.refs.SUCCESSPAY.open();
    this.props.successPay();
  }
