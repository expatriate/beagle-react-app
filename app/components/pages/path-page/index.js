...
import { LinearGradient, Svg, Video } from 'expo';
...
import { navigateToOnplace, navigateToSearch } from '../../../actions';
    ...
    return (
      <View style={styles.container}>
        ...
        <Video
          ...
          usePoster={false}
          onReadyForDisplay={this.startVideo}
          style={[styles.video, { width: Math.round(762*height/572), height: height, left: -(Math.round(762*height/572) - width)/2}]}
        />
        ...
        </View>
        {
          ...
          <View style={{position: 'relative', flex: 1, alignItems: 'center', justifyContent: 'center'}}>
            <ActivityIndicator size="large" color="#E10C1C" />
          </View>
          : null
        }
      </View>);
